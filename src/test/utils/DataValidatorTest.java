...
public class DataValidatorTest {
    ...
    public void isNumberInvalid(String str){
        assertFalse(DataValidator.isNumber(str));
    }

    @ParameterizedTest
    @ValueSource(strings = {"   ", "  68024", "1952   09090", "  ", " 0.0 "})
    public void isNumberInvalidFormatting(String str){
        assertFalse(DataValidator.isNumber(str));
    }

    @ParameterizedTest
    @ValueSource(strings = {"41a6", "796v", "6g23", "59hy0", "7ol", "8po5"})
    public void isNumberWithLetter(String str){
        assertFalse(DataValidator.isNumber(str));
    }
    ...
    @ParameterizedTest
    @ValueSource(strings = {"11.1", "2296.2", "33.33", "44,58", "5,85", "66,62", "77785´855", "8*66"})
    public void isDateInvalid(String str){
        Date date = DataValidator.formatStringInDate(str);
    ...
    @ParameterizedTest
    @ValueSource(strings = {"   ", "  68024", "1952   09090", "  ", " 0.0 "})
    public void isDateInvalidFormatting(String str){
        Date date = DataValidator.formatStringInDate(str);
        assertNull(DataValidator.formatDateInString(date));
    }
    ...
    @ParameterizedTest
    @ValueSource(strings = {"41a6", "796v", "6g23", "59hy0", "7ol", "8po5"})
    public void isDateWithLetter(String str){
        Date date = DataValidator.formatStringInDate(str);
        assertNull(DataValidator.formatDateInString(date));
    }

    @Test
    public void isStringToDate(){
